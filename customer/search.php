            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        <a href="search.php" class="list-group-item list-group-item-action <?php echo (!$categoryId) ? 'active' : ''; ?>">
                            All Categories
                        </a>
                        <?php foreach ($categories as $category): ?>
                            <a href="search.php?category=<?php echo $category['id']; ?><?php echo !empty($query) ? '&q=' . urlencode($query) : ''; ?><?php echo !empty($location) ? '&location=' . urlencode($location) : ''; ?>" class="list-group-item list-group-item-action <?php echo ($categoryId == $category['id']) ? 'active' : ''; ?>">
                                <?php echo htmlspecialchars($category['name']); ?>
                            </a>
                        <?php endforeach; ?>
                    </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card service-card h-100 border-primary">
                                    ...
                                    <div class="card-footer bg-transparent border-top-0">
                                        <a href="search.php?service_id=<?php echo $service['id']; ?>" class="btn btn-primary">View Details</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
