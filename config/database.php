    ...
    try {
        ...
        if ($categoriesExist['count'] == 0) {
            $categories = [
                ...
                ['Health & Wellness', 'Medical, fitness, therapy, etc.'],
                ['Education & Tutoring', 'Academic, skills, language, etc.'],
                ['Technical Services', 'IT support, web development, etc.'],
                ['Beauty & Personal Care', 'Hair, makeup, spa, etc.'],
                ['Event Services', 'Planning, catering, entertainment, etc.'],
                ['Auto Services', 'Repairs, maintenance, detailing, etc.']
            ];
