...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] !== UPLOAD_ERR_NO_FILE) {
        ...
        if ($_FILES['image']['error'] !== UPLOAD_ERR_OK) {
            ...
            $newName = 'service_' . time() . '_' . rand(1000, 9999) . '.' . $ext;
        ...
        try {
            if ($action === 'add' || ($action === 'edit' && !$serviceId)) {
                $stmt = $pdo->prepare("
                    ...
                    (provider_id, category_id, title, description, price_range, availability, is_active, image_path)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                ");
                $stmt->execute([
                    $providerId,
                ...
                // If a new image is uploaded, update image_path, else keep old
                if ($imagePath !== null) {
                    $stmt = $pdo->prepare("
                        UPDATE services 
                        SET category_id = ?, title = ?, description = ?, price_range = ?, availability = ?, is_active = ?, image_path = ?
            ...
            header('Location: http://localhost/BusinessServiceTracker/provider/services.php');
            exit();
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="http://localhost/BusinessServiceTracker/provider/services.php?action=add" class="btn btn-primary">
            ...
            <?php foreach ($services as $service): ?>
                <div class="col-md-4 mb-4">
                    <div class="card service-card h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-weight: bolder;"><?php echo htmlspecialchars($service['title']); ?></h5>
                        ...
                        <div class="card-footer bg-transparent border-top-0">
                            <div class="d-flex justify-content-between">
                                <a href="http://localhost/BusinessServiceTracker/provider/services.php?action=edit&id=<?php echo $service['id']; ?>" class="btn btn-sm btn-primary">
        ...
        <div class="col-md-12 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . '?action=' . $action . ($serviceId ? '&id=' . $serviceId : '')); ?>" class="needs-validation" novalidate enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="price_range" name="price_range" value="<?php echo isset($_POST['price_range']) ? htmlspecialchars($_POST['price_range']) : (isset($service['price_range']) ? htmlspecialchars($service['price_range']) : ''); ?>" placeholder="e.g., R50-R100, Starting from R75, etc.">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Optional: Upload an image for your service (JPG, PNG, GIF).</div>
                            <?php if (!empty($service['image_path'])): ?>
                                <div class="mt-2">
                                    <img src="<?php echo htmlspecialchars('../' . $service['image_path']); ?>" alt="Service Image" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="http://localhost/BusinessServiceTracker/provider/services.php" class="btn btn-outline-secondary me-md-2">Cancel</a>
